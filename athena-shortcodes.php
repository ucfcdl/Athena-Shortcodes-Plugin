...
if ( ! function_exists( 'athena_sc_init' ) ) {
	function athena_sc_init() {
		...
		// Update markup generated by WordPress.
		// If this is activated, [caption]'s get wiped from the generated image markup :(
		// add_filter( 'get_image_tag', array( 'ATHENA_SC_Config', 'format_image_output' ), 10, 6 );

		add_filter( 'image_send_to_editor', array( 'ATHENA_SC_TinyMCE_Config', 'format_image_output' ), 21, 8 ); // must be priority greater than 20

		add_filter( 'img_caption_shortcode_width', '__return_false' );
		// add_filter( 'get_image_tag_class', array( 'ATHENA_SC_Config', 'format_image_output_classes' ) );
