 ...
 **/
if ( ! class_exists( 'LinkSC' ) ) {
	class LinkSC extends ATHENA_SC_Shortcode {
		public
			$command = 'link',
			$name = 'Link',
			$desc = 'Inserts a generic link. Useful for wrapping content and shortcodes in a link that would otherwise get stripped by the WYSIWYG editor.',
			$content = true,
			$preview = false,
